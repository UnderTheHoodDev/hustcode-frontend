...
interface AdminProblemFilterProps {
  difficulty: string;
        ...
        <div className="flex items-center gap-4">
          ...
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            ...
            >
              ...
              <SelectItem value="APPROVED" className="text-gray-200">
                Approved
              </SelectItem>
              <SelectItem value="REJECTED" className="text-gray-200">
                Rejected
              </SelectItem>
            </SelectContent>
          </Select>
...
export default AdminProblemFilter;

...
export function DateTimePicker({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        className="w-auto border-[#3a4556] bg-[#1e293b] p-0"
        align="start"
      >
        <Calendar
          mode="single"
        ...
        />
        <div className="flex items-center gap-2 border-t border-[#3a4556] p-3">
          <Clock className="h-4 w-4 text-gray-400" />
          <Input
            type="time"
            value={time}
            onChange={handleTimeChange}
            className="w-full border-[#3a4556] bg-[#252d3d] text-gray-200"
          />
        </div>
      </PopoverContent>
    </Popover>
